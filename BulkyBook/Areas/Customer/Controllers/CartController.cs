...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.PostalCode = ShoppingCartVM.OrderHeader.ApplicationUser.PostalCode.ToString();
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            else
            {
                ...
                Charge charge = service.Create(options); // this line will make a transaction that will charge from customer credit card
            ...
            _unitOfWork.Save();
            return RedirectToAction("SuccessOrder", "Cart", new { id = ShoppingCartVM.OrderHeader.Id });
        }
